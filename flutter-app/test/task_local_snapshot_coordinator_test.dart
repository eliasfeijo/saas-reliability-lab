...
void main() {
  test('local snapshot coordinator prunes deleted anonymous tombstones on load', () async {
    ...
    final coordinator = TaskLocalSnapshotCoordinator(repository);
  ...
  test('local snapshot coordinator removes target task ids and persists the remaining snapshot', () async {
