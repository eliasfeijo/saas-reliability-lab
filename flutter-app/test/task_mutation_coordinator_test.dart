...
void main() {
  ...
  test('task mutation coordinator tombstones account tasks and removes anonymous tasks on delete', () {
  ...
  test('task mutation coordinator adopts anonymous tasks into the authenticated account', () {
    final anonymousTask = buildTask(
  ...
  test('task mutation coordinator returns the first changed task for completion sync', () {
