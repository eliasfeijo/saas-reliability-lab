...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        (left(tester, 'Task Queue') - left(tester, 'Queue Controls')).abs(),
        lessThan(1),
      );
  ...
  testWidgets('compact queue controls wrap filter badges into multiple rows', (
    tester,
  ) async {
    tester.view.devicePixelRatio = 1.0;
    tester.view.physicalSize = const Size(540, 900);
