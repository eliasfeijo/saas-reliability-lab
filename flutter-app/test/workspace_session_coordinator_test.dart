...
void main() {
  ...
  test('session coordinator initialization surfaces anonymous review without forcing sync', () async {
    ...
    final userSession = InMemoryUserSessionService(runtimeDebug: runtimeDebug);
  ...
  test('session coordinator signed-out flow clears local user and workspace snapshot', () async {
